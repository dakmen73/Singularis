// ForgeCss.Core/Models/Ast.cs
namespace ForgeCss.Core.Models;

public abstract record Node;

public record Stylesheet(IReadOnlyList<Statement> Statements) : Node;
...
public record ExecRule(Value Command, Value? WorkingDirectory) : AtRule;
